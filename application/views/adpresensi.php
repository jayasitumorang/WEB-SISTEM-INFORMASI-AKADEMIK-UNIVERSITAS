...
<label>absen :</label>
<input type="text" name="ABSEN" id="ABSEN" required="required" placeholder=""/><br/><br />
...
$sql = "INSERT INTO presensi (nim, kehadiran,absen,pertemuan)
VALUES ('".$_POST["nim"]."','".$_POST["NAMA"]."','".$_POST["ABSEN"]."','".$_POST["PROGRAM"]."')";
